...
var incompleteTaskHolder=document.getElementsByClassName("list")[0];//uncompleted tasks
var completedTasksHolder=document.getElementsByClassName("list_done")[0];//completed-tasks
...
var createNewTaskElement=function(taskString){
    ...
    editButton.classList.add("btn", "item__edit-btn");

    deleteButton.classList.add("btn", "item__delete-btn");
